...
用法:
  python make_ci_us.py --order_ids "d00001"
  python make_ci_us.py --order_ids "d00001,d00002"

通过 Sills.document_generator 模块生成 CI，无直接SQL语句。
"""
...
def main():
    ...
    # 调用核心模块生成 CI
    success, result = generate_ci_us(order_ids, output_base=args.output_dir)
