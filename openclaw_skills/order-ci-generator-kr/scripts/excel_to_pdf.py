...
# -*- coding: utf-8 -*-
"""
Excel to PDF Converter for CI Generator (KR)
将 CI Excel 文件转换为 PDF 格式

创建时间: 2026-03-08
功能: 将生成的 CI Excel 文件转换为 PDF，用于发送给客户
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="CI Excel 转 PDF 工具")
